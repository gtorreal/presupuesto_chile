          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-gray-700">
                ...
                <th className="text-left text-gray-400 font-medium pb-2 pr-4">Símbolo interno</th>
            ...
            <tbody className="divide-y divide-gray-800">
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">NDF USDCLP 1M</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">USDCLP_NDF</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.55</td>
                <td className="py-2.5 pr-4 text-gray-300">Directo</td>
                <td className="py-2.5 text-gray-400">Stub manual (futuro: Bloomberg/Reuters)</td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">USD/BRL</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">USDBRL</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.20</td>
                <td className="py-2.5 pr-4 text-gray-300">Directo</td>
                <td className="py-2.5 text-gray-400">Yahoo Finance / Frankfurter (ECB)</td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">DXY (Índice Dólar)</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">DXY</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.15</td>
                <td className="py-2.5 pr-4 text-gray-300">Directo</td>
                <td className="py-2.5 text-gray-400">Yahoo Finance (DX-Y.NYB)</td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">Cobre (HG Futures)</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">COPPER</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.10</td>
                <td className="py-2.5 pr-4 text-emerald-400">Invertido ↑cobre = ↓USDCLP</td>
                <td className="py-2.5 text-gray-400">Yahoo Finance (HG=F)</td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">USD/MXN</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">USDMXN</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.08</td>
                <td className="py-2.5 pr-4 text-gray-300">Directo</td>
                <td className="py-2.5 text-gray-400">Yahoo Finance / Frankfurter (ECB)</td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">VIX (volatilidad S&P)</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">VIX</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.05</td>
                <td className="py-2.5 pr-4 text-gray-300">Directo</td>
                <td className="py-2.5 text-gray-400">Yahoo Finance (^VIX)</td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">US10Y (Bono 10Y EE.UU.)</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">US10Y</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.04</td>
                <td className="py-2.5 pr-4 text-gray-300">Directo</td>
                <td className="py-2.5 text-gray-400">Yahoo Finance (^TNX)</td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">USD/COP</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">USDCOP</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.04</td>
                <td className="py-2.5 pr-4 text-gray-300">Directo</td>
                <td className="py-2.5 text-gray-400">Yahoo Finance / Frankfurter (ECB)</td>
              </tr>
              <tr>
                <td className="py-2.5 pr-4 text-gray-100">ECH (ETF Chile iShares)</td>
                <td className="py-2.5 pr-4 font-mono text-gray-400">ECH</td>
                <td className="py-2.5 pr-4 text-right font-mono text-amber-300">0.03</td>
                <td className="py-2.5 pr-4 text-emerald-400">Invertido ↑ECH = ↓USDCLP</td>
                <td className="py-2.5 text-gray-400">Yahoo Finance (ECH)</td>
              </tr>
            </tbody>
            <tfoot>
              <tr className="border-t border-gray-700">
                ...
                <td colSpan={2} className="pt-2.5 text-gray-500 text-xs">
